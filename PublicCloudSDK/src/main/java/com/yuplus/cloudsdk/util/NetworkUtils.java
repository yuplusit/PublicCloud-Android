...
import com.yuplus.cloudsdk.enums.EApnType;
import com.yuplus.cloudsdk.enums.ENetworkType;
import com.yuplus.cloudsdk.enums.EOperatorType;
...
public class NetworkUtils {
    ...
    public static Proxy getNetworkProxy(Context context) {
        ...
        if (type != ConnectivityManager.TYPE_WIFI) {
            ...
            if(StringUtils.isNotEmpty(host) && port != -1) {

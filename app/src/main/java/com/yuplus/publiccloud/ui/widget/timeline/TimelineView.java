package com.yuplus.publiccloud.ui.widget.timeline;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, DensityUtils.dip2px(mContext, 20));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, DensityUtils.dip2px(mContext, 2));

...
public class XRecyclerView extends RecyclerView {
    ...
    private RefreshPullDirectionListener mRefreshPullDirectionListener;
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                ...
                Log.d("onScrollStateChanged", "state:" + state);
                isLoadingData = true;
                if (mFootView instanceof LoadingMoreFooter) {
    ...
    public void setStateListener(StateListener listener) {
        ...
        if (null != mRefreshHeader) {
            mRefreshHeader.setStateListener(listener);
        }
    }

    public void setRefreshPullDirectionListener(RefreshPullDirectionListener listener) {
        this.mRefreshPullDirectionListener = listener;
        if (null != mRefreshHeader) {
            mRefreshHeader.setRefreshPullDirectionListener(listener);
        }
    }
    ...
    public interface RefreshPullDirectionListener {
